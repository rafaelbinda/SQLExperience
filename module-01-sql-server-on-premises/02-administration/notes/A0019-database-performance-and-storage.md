...
- [Inicialização instantânea de arquivos de banco de dados](https://learn.microsoft.com/pt-br/sql/relational-databases/databases/database-instant-file-initialization?view=sql-server-ver16)
...
- [Recomendações para reduzir a contenção de alocação no tempdb](https://learn.microsoft.com/pt-br/troubleshoot/sql/database-engine/performance/recommendations-reduce-allocation-contention)
- [sys.dm_io_virtual_file_stats (Transact-SQL)](https://learn.microsoft.com/pt-br/sql/relational-databases/system-dynamic-management-views/sys-dm-io-virtual-file-stats-transact-sql?view=sql-server-ver16)
- [sys.dm_os_wait_stats (Transact-SQL)](https://learn.microsoft.com/pt-br/sql/relational-databases/system-dynamic-management-views/sys-dm-os-wait-stats-transact-sql?view=sql-server-ver16)
