...
1 - 	Testar SQL SERVER BROWSER (UDP 1434) - O SQL Server Browser tem que estar ligado
	...
	1º - Olhando o SQL Server Configuration Manager	→ Protocols for MSSQLSERVER	→ Named Pipes = Disabled
	2º - Ao iniciar o Windows quando olho no Event Viewer é possível ver a seguinte mensagem:
